...
// Signed dollars — e.g. −$12.50 / $8.00 (register over/short).
const usd = (v: MVal) => (isNum(v) ? `${v < 0 ? "−" : ""}$${Math.abs(v).toFixed(2)}` : typeof v === "string" ? v : "—");
...
const FOCUS: Card[] = [
  ...
  { title: "Cash +/-", goal: "Zero Variance", key: "cashOverShort", fmt: usd, good: (v) => v >= 0 },
];
