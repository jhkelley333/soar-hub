...
// execution metrics: Avg Ticket Time + On Time + VOG (from the ranker) + SPLH +
// Tickets + Average Check. Order Accuracy, Delivery Mix, and Complaints were
// dropped. Other pillars will be re-added in follow-up passes.
