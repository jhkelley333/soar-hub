  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        aria-hidden="true"
      />
      {/* Dialog is a flex column capped at the viewport height (minus the p-4
          gutter): the header and footer stay pinned (shrink-0) and the body is
          the scrollable region, so a tall form never clips off the top. */}
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
